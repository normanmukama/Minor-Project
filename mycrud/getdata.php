...
if(isset($_POST['update_child'])){
    ...
    $query = "UPDATE orphans SET first_name='$fname', last_name='$lname', date_of_birth='$date_of_birth',current_country='  $current_country',current_district='$district',guardian='$guardian' WHERE id='$child_id'";
    $query_run = mysqli_query($conn, $query);
...
//    $country_of_origin =  $_POST['country_of_origin'];
   $current_country =  $_POST['current_country'];
    ...
    $query = "INSERT INTO orphans(first_name, last_name, date_of_birth, current_country ,current_district ,guardian) VALUES
     ('$fname', '$lname','$date_of_birth','$current_country',' $district','$guardian')";
    $query_run = mysqli_query($conn, $query);
    if($query_run){
