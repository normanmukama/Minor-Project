    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../crud1/index.php">All staff</a>
                        </div>
                    </div>
                </li>
                            <!-- student details -->
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="tables.php">All children</a>
                            <a class="collapse-item" href="#">All children</a>
                        </div>
                    </div>
                </li>
                ...
                <!-- <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../gallery/upload-photo.php">Images</a>
                            <a class="collapse-item" href="../gallery/index.php">Gallery</a>
                ...
                <!-- Nav Item - Charts -->
                <li class="nav-item">
                    <a href="" class="nav-link"><i class="fas fa-mail-bulk "></i> Messages</a>
                </li>
